...
LOG_FILE_FMT = "%(levelname)s - %(asctime)s - %(name)s - %(module)s.%(funcName)s - " \
               "%(threadName)s - %(message)s in %(pathname)s:%(lineno)d"
            ...
            def __init__(self, fmt=None, datefmt=None, style='%', validate=True):
                ...
                self._colors = {
                    ...
                    logging.getLevelName(logging.ERROR): (
                        consts.RED + consts.BOLD,
                        consts.NBOLD + consts.DEF
                    ),
                    logging.getLevelName(logging.CRITICAL): (
                        consts.CYAN + consts.BGRED,
                        consts.BGDEF + consts.DEF
                    ),
