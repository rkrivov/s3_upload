...
from s3.base import S3Base, INFO_OLD, INFO_NEW, INFO_OP, OP_BACKUP, INFO_FIELD_NAME, INFO_FIELD_MTIME, \
    INFO_FIELD_SIZE, INFO_FIELD_HASH
        ...
        for operation_info in operations_list:
            ...
            if remote_file_info is not None:
                ...
                if remote_file_name.startswith(self._local_path):
                    ...
                    remote_file_name = utils.remove_start_path_sep(remote_file_name)
                    remote_file_name = os.path.join(utils.append_end_path_sep(self._archive_path), remote_file_name)
